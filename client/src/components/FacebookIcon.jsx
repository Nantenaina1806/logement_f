// lucide-react tsy manana icon "Facebook" intsony (nesorina tamin'ny brand icons
// tao amin'ny version farany), koa SVG manokana no ampiasaina eto.
export default function FacebookIcon({ size = 18, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
